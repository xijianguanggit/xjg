 ...
 * @date 2017/9/5
 */
public class ReplaceAll extends AbstractVariadicFunction {
    @Override
    public AviatorObject variadicCall(Map<String, Object> env, AviatorObject... args) {
        ...
        return new AviatorString(AviatorEvaluator.execute("string.replace_all(s,regex,replacement)", env).toString());
    }
