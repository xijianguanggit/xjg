...
INSERT INTO t_dict
(code,name,cata_code,seq,create_time,create_by,update_time,update_by,update_count)
VALUES
('undefinefile','未建档','t_sales_clues.stage',1,now(),623,now(),623,0),
('potentialbusiness','潜在商机','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('firstvisit','初次拜访','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('projectcom','方案沟通','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('projectbid','项目报价','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('businesstalk','商务谈判','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('signcontract','合同签约','t_sales_clues.stage',3,NULL,623,NULL,623,0),
('ka','KA','t_customer.type',3,NULL,632,NULL,632,0),
('canal','渠道','t_customer.type',3,NULL,632,NULL,632,0);
...
-- 工作项表新增模块字段
-- ----------------------------
 alter table t_issue add module_id bigint(20);
 ...
 PRIMARY KEY (`id`),
 UNIQUE INDEX `uniq_projid_name` (`proj_id`, `name`) USING BTREE
)
COLLATE='utf8_general_ci';
--- 销售线索
 DROP TABLE IF EXISTS `t_saleact`;
CREATE TABLE `t_saleact` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `clues_id` bigint(20) NOT NULL COMMENT '销售线索id',
  `join_name` varchar(20) DEFAULT NULL COMMENT '参与人',
  `place` varchar(20) DEFAULT NULL COMMENT '地点',
  `content` varchar(20) DEFAULT NULL COMMENT '活动内容',
  `marks` varchar(200) DEFAULT NULL COMMENT '说明',
  `create_time` datetime DEFAULT NULL,
  `create_by` bigint(20) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `update_by` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='销售活动表';
 DROP TABLE IF EXISTS `t_sales_clues`;
 CREATE TABLE `t_sales_clues` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `proname` varchar(20) NOT NULL COMMENT '项目名称',
  `follow_id` bigint(20) DEFAULT NULL COMMENT '跟进人id',
  `stage` varchar(20) NOT NULL COMMENT '阶段id',
  `init_contacts` varchar(20) NOT NULL COMMENT '初始联系方式',
  `customer_id` bigint(20) DEFAULT NULL COMMENT '客户id',
  `budget` varchar(20) DEFAULT NULL COMMENT '项目预算',
  `content` varchar(20) DEFAULT NULL COMMENT '项目内容',
  `reportor` varchar(20) DEFAULT NULL COMMENT '报备人姓名',
  `reportorg` varchar(20) DEFAULT NULL COMMENT '报备人所在部门',
  `report_contact` varchar(200) DEFAULT NULL COMMENT '报备人联系方式',
  `create_time` datetime NOT NULL,
  `create_by` bigint(20) NOT NULL,
  `update_time` datetime NOT NULL,
  `update_by` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='销售线索表';
 DROP TABLE IF EXISTS `t_customer`;
CREATE TABLE `t_customer` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT '客户姓名',
  `type` varchar(20) DEFAULT NULL COMMENT '分类KA、渠道',
  `marks` varchar(200) DEFAULT NULL COMMENT '说明',
  `create_time` datetime NOT NULL,
  `create_by` bigint(20) NOT NULL,
  `update_time` datetime NOT NULL,
  `update_by` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=479 DEFAULT CHARSET=utf8 COMMENT='客户';
...
CREATE TABLE `t_contacts` (
  ...
  `mail` varchar(20) DEFAULT NULL COMMENT 'mail',
  `create_time` datetime NOT NULL,
  `create_by` bigint(20) NOT NULL,
  `update_time` datetime NOT NULL,
  `update_by` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='联系人表';
